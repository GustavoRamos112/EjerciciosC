//Chicharronera dividida en subrutinas
//Este ejercicio ayuda a la comprension de las variables globales y las subrutinas
...
//son las tres subrutinas, al no devolver nada, son vacias
void lec(void);
void rai(void);
void esc(void);
...
void lec()
{
    ...
    fscanf(entrada, "%lf", &Adi);
    fscanf(entrada, "%lf", &Bdi);
    fscanf(entrada, "%lf", &Cdi);
    fclose(entrada);
}
